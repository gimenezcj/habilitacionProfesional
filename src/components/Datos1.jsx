...
const ImageButton=[
  <RiCheckboxFill width="80px" height="80px"/>,
  <RiCheckboxFill width="80px" height="80px"/>,
  <RiAlertFill width="80px" height="80px"/>,
  <RiAlertFill width="80px" height="80px"/>,
  <RiAlertFill width="80px" height="80px"/>]
...
function Datos1 (props) {
  ...
  return (
    <>
      <tr>
        <td rowSpan="5" style={{"background-color":color[nivel],"width":"10%","vertical-align": "middle","text-align": "center","font-size":"10vh"}}>
